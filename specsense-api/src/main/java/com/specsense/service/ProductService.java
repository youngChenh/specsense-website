...
public interface ProductService {
    PageResult<List<ProductDTO>> getList(Long categoryId, String categoryKey, Boolean featured, String keyword, int page, int pageSize, String locale);
    ProductDTO getBySlug(String slug, String locale);
    Product getById(Long id);
    List<ProductDTO> getFeatured(int limit, String locale);
    ProductSearchResultDTO search(String keyword, String locale);
